...
# Test 5: Test Accelerator
print("  Test 5: Testing multi-GPU setup...")
try:
    test_accelerator = Accelerator()
    print(f"  ✅ Accelerator initialized: {test_accelerator.num_processes} process(es)")
    del test_accelerator
except Exception as e:
    print(f"  ⚠️  Accelerator warning: {e}")
